...
class ResNet_s(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_layers, num_classes, device):
        ...
        self.layer4 = self._make_layer(block, 256, num_blocks[3], device=device, kernel=5, stride=2)
...
def resnet(num_layers, num_classes, device):
    return ResNet_s(BasicBlock, [3, 4, 6, 3], num_layers, num_classes=num_classes, device=device)
